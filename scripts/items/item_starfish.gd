class_name ItemStarfish
extends Item


var powerup_starfish_packed = preload("res://scenes/powerups/power_up_starfish.tscn")
...
func use_item(item_component:KartItemUseComponent) -> void:
	...
	var powerup : PowerUp = powerup_starfish_packed.instantiate()
	...
	powerup.velocity += -car.global_basis.z * 15
